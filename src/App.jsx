...
export function App() {
  ...
  const featureStrip = [['Geofence automations','Arrive home. Things happen.',Waves],['Private by design','Your home. Your data.',LockKeyhole],['On-device intelligence','Fast, local, secure.',Microchip],['HomeKit native','Deep integration that works.',Home],['Future ready','Built to evolve with your home.',Infinity]];
