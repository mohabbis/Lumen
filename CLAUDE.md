...
**Audience and tone:** calm, low cognitive load, neurodivergent-first. Design takes inspiration from Tiimo, an Apple Design Award winner built for ADHD and autistic planners, applied to the home. Not a power-user HomeKit dashboard, not a tinkerer tool. **Competitive benchmark (internal only, never in public copy):** Controller for HomeKit — Lumen wins on calm, explainability, and consent-before-action, not toggle density.
